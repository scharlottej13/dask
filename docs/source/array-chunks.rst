...
.. image:: images/reshape.png
   :alt: Visual representation of a 2-dimensional (3 by 4) NumPy array being reshaped to 1 dimension (12 by 1). Arrows indicate the order in which values are from the original array are copied to the new array, moving across the columns in axis 1 first before moving down to the next row in axis 0.
